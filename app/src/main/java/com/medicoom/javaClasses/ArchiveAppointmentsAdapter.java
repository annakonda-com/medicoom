...
public class ArchiveAppointmentsAdapter extends ArrayAdapter<Map.Entry<Integer, AppointmentOnDate>> {
    FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
    String med_name_dosage;

    public ArchiveAppointmentsAdapter(Context context, ArrayList<Map.Entry<Integer, AppointmentOnDate>> arr) {
